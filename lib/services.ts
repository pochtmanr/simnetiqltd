...
const servicesEn: Service[] = [
  ...
  },
  {
    ...
    services: [
      { code: "S-01", title: "LLM Feature Engineering", text: "Prompt architecture, caching, streaming, tool-use, structured outputs. Built against evaluations, not opinions." },
      { code: "S-02", title: "Retrieval & RAG Pipelines", text: "Embedding stores (pgvector, Pinecone, Weaviate), hybrid search, re-ranking, chunking strategies tuned per corpus." },
      { code: "S-03", title: "Agentic Automation", text: "Multi-step agents with tool orchestration, memory, human-in-the-loop checkpoints, and guardrails." },
      { code: "S-04", title: "Voice & Multimodal", text: "Whisper, Deepgram, ElevenLabs, Claude Vision. Voice agents, transcription, image and document ingestion." },
      { code: "S-05", title: "Evaluation & Monitoring", text: "Custom eval harnesses, regression tracking, cost dashboards, prompt versioning, drift detection." },
      { code: "S-06", title: "Model Selection & Fine-Tuning", text: "Benchmarking across Claude, GPT, Gemini, Llama, Mistral. LoRA fine-tuning and distillation where it pays off." },
    ],
    techStack: [
      { label: "Foundation models", items: ["Claude (Anthropic)", "GPT-4 / GPT-5 (OpenAI)", "Gemini", "Llama", "Mistral", "DeepSeek"] },
      { label: "Orchestration", items: ["Claude Agent SDK", "LangGraph", "Temporal", "Inngest", "LiteLLM"] },
      { label: "Retrieval", items: ["pgvector", "Pinecone", "Weaviate", "Qdrant", "Typesense"] },
      { label: "Voice & Vision", items: ["Whisper", "Deepgram", "ElevenLabs", "OpenAI Realtime", "Claude Vision"] },
      { label: "Infrastructure", items: ["Python", "TypeScript", "FastAPI", "Next.js", "Modal", "Replicate"] },
      { label: "Evaluation", items: ["Braintrust", "Langfuse", "promptfoo", "custom harnesses"] },
    ],
    pricing: [
      { name: "Pilot", price: "FROM £500", blurb: "Scoped prototype or feature spike.", bullets: ["One end-to-end workflow", "Prompt design + caching", "Cost & latency benchmarking", "Written recommendation report"] },
      { name: "Integration", price: "FROM £1.5K", blurb: "Production LLM feature built to brief — scope to whatever the client needs.", highlighted: true, bullets: ["Scoped to client requirements", "Retrieval, tool-use, or agentic", "Eval harness & monitoring", "Deployed into your infrastructure", "30 days post-launch tuning"] },
      { name: "Platform", price: "CUSTOM", blurb: "Dedicated AI programme, longer horizon, regulated domains.", bullets: ["Multi-pipeline architecture", "Dedicated evaluation infrastructure", "On-prem or VPC deployment", "Signed SLA"] },
    ],
    meta: [
...
const servicesHe: Service[] = [
  ...
  },
  {
    slug: "ai-integration",
    code: "C-03",
    badge: "LLM · RAG · סוכנים",
    title: "אינטגרציית AI",
    tagline: "מערכות LLM ברמת ייצור.",
    summary:
    ...
    services: [
      { code: "S-01", title: "הנדסת תכונות LLM", text: "ארכיטקטורת prompts, caching, streaming, שימוש בכלים, פלטים מובנים. נבנה מול הערכות, לא דעות." },
      { code: "S-02", title: "אחזור וצינורות RAG", text: "מאגרי embeddings (pgvector, Pinecone, Weaviate), חיפוש היברידי, דירוג מחדש ואסטרטגיות chunking המכווננות לכל קורפוס." },
      { code: "S-03", title: "אוטומציה אגנטית", text: "סוכנים רב-שלביים עם תזמור כלים, זיכרון, נקודות בקרה אנושיות ומעקות בטיחות." },
      { code: "S-04", title: "קול ורב-מודל", text: "Whisper, Deepgram, ElevenLabs, Claude Vision. סוכני קול, תמלול, קליטת תמונות ומסמכים." },
      { code: "S-05", title: "הערכה וניטור", text: "רתימות הערכה מותאמות, מעקב רגרסיה, דשבורדי עלות, ניהול גרסאות prompt וזיהוי דריפט." },
      { code: "S-06", title: "בחירת מודל וכיוונון", text: "השוואות מול Claude, GPT, Gemini, Llama, Mistral. כיוונון LoRA וזיקוק כשזה משתלם." },
    ],
    techStack: [
      { label: "מודלי יסוד", items: ["Claude (Anthropic)", "GPT-4 / GPT-5 (OpenAI)", "Gemini", "Llama", "Mistral", "DeepSeek"] },
      { label: "תזמור", items: ["Claude Agent SDK", "LangGraph", "Temporal", "Inngest", "LiteLLM"] },
      { label: "אחזור", items: ["pgvector", "Pinecone", "Weaviate", "Qdrant", "Typesense"] },
      { label: "קול וראייה", items: ["Whisper", "Deepgram", "ElevenLabs", "OpenAI Realtime", "Claude Vision"] },
      { label: "תשתית", items: ["Python", "TypeScript", "FastAPI", "Next.js", "Modal", "Replicate"] },
      { label: "הערכה", items: ["Braintrust", "Langfuse", "promptfoo", "רתימות מותאמות"] },
    ],
    pricing: [
      { name: "פיילוט", price: "החל מ-£500", blurb: "אב-טיפוס מוגדר או ספייק תכונה.", bullets: ["תהליך עבודה אחד מקצה לקצה", "עיצוב prompt + caching", "השוואת עלות וזמן תגובה", "דוח המלצות כתוב"] },
      { name: "אינטגרציה", price: "החל מ-£1.5K", blurb: "תכונת LLM ברמת ייצור הנבנית לפי תיק — בהיקף שהלקוח צריך.", highlighted: true, bullets: ["מוגדר לדרישות הלקוח", "אחזור, שימוש בכלים או אגנטי", "רתימת הערכה וניטור", "פרוס לתשתית שלכם", "30 יום של כיוונון לאחר השקה"] },
      { name: "פלטפורמה", price: "מותאם", blurb: "תוכנית AI ייעודית, אופק ארוך יותר, תחומים מוסדרים.", bullets: ["ארכיטקטורה רב-צינורית", "תשתית הערכה ייעודית", "פריסה On-prem או VPC", "SLA חתום"] },
    ],
    meta: [
      { label: "ספקים עיקריים", value: "Anthropic · OpenAI" },
      { label: "שפות", value: "Python · TypeScript" },
      { label: "ייחוס", value: "Creator AI" },
    ],
  },
  {
    slug: "web-platforms",

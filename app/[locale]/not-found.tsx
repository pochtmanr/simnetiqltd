          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 self-end">
              <p className="text-body max-w-md">
                The page you requested is not in our archive. It may have been
                moved, decommissioned, or never existed. Head back to base or
                jump directly to an active deployment.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
              ...
              <div className="lg:col-span-7">
                ...
                <p className="text-body mb-8 max-w-lg">
                  No trace of this resource. Pick a route below — every link
                  goes to a live page. If you landed here from an old
